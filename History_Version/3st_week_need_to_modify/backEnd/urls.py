...
from article.views import article_operation, comment_operation, user_operation, test
...
urlpatterns = [
    ...
    url(r'^logout/?', logout),
    url(r'article/comment/?', comment_operation),
    url(r'article/(\d+)', article_operation),
    url(r'user/?', user_operation),
    url(r'test', test)
]
